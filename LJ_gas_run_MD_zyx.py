...
=======
file_name_base = "my_simulation_0.01_5000_NVE"  # file name for all output files
>>>>>>> Stashed changes
...
velocity_trajectory[0,:,:] = ps.velocity # initial velocity
...
for i in range(sim.n_steps):
    ...
    velocity_trajectory[i+1,:,:] = ps.velocity # store updated velocities
